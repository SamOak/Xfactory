...
public class TransformController {
	...
	public TransformControllerData transformRESTJSON(@PathVariable(value = "xsltname") String xsltFileName,
			@Valid @RequestBody String source) {
	...
	public String transformRESTXML(@PathVariable(value = "xsltname") String xsltFileName,
			@Valid @RequestBody String source) {
